        ...
        <header className="bg-[#0e1a26]/80 backdrop-blur-md border-b border-[#2a3a4a] p-6 sticky top-0 z-10">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-[#a9c7d8]">Gestión completa del sistema Taskly</p>
            </div>
            <div className="flex items-center space-x-4">
              <div className="relative">
                <button className="w-10 h-10 rounded-full bg-[#1a2a3a] flex items-center justify-center hover:bg-[#2a3a4a] transition-colors">
              ...
              <button 
                onClick={() => router.push('/')}
                className="px-4 py-2 rounded-lg bg-[#1a2a3a] hover:bg-[#2a3a4a] transition-colors flex items-center"
              >
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-[#1a2a3a]/50 backdrop-blur-sm border border-[#2a3a4a]/30 rounded-2xl p-6">
                  ...
                  <div className="text-sm text-[#a9c7d8] mt-1">
                ...
                <div className="bg-[#1a2a3a]/50 backdrop-blur-sm border border-[#2a3a4a]/30 rounded-2xl p-6">
                  ...
                  <div className="text-sm text-[#a9c7d8] mt-1">{stats.teams} equipos activos</div>
                </div>
                ...
                <div className="bg-[#1a2a3a]/50 backdrop-blur-sm border border-[#2a3a4a]/30 rounded-2xl p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="w-10 h-10 rounded-lg bg-[#0e1a26] flex items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#ffb366]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    {[
                      ...
                      <div key={index} className="flex items-start">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-sm text-[#a9c7d8]">Por {activity.user} · {activity.time}</div>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="bg-[#1a2a3a]/50 backdrop-blur-sm border border-[#2a3a4a]/30 rounded-2xl p-6">
                  <h3 className="font-semibold mb-4">Distribución de Usuarios</h3>
                  <div className="flex items-center justify-center h-64">
                    <div className="text-center">
                      <div className="w-40 h-40 rounded-full border-4 border-[#5ab9ea] flex items-center justify-center mx-auto mb-4">
                        <div className="text-2xl font-bold">72%</div>
                      </div>
                      <p className="text-[#a9c7d8]">Usuarios activos este mes</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#1a2a3a]/50 backdrop-blur-sm border border-[#2a3a4a]/30 rounded-2xl p-6">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <button className="text-sm text-[#5ab9ea] hover:underline">Ver todos</button>
                </div>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-[#2a3a4a]">
                        ...
                        <th className="pb-3 text-left">Último acceso</th>
                        <th className="pb-3 text-left">Tareas</th>
                        <th className="pb-3 text-left">Rol</th>
                        ...
                        <tr key={user.id} className="border-b border-[#2a3a4a]/30">
                          <td className="py-3">
                            <div className="flex items-center">
                              <div className="w-8 h-8 rounded-full bg-gradient-to-r from-[#5ab9ea] to-[#84ceeb] flex items-center justify-center text-[#0e1a26] font-bold mr-3">
                                {user.name.charAt(0)}
                              </div>
                              <div>
                                <div className="font-medium">{user.name}</div>
                                <div className="text-sm text-[#a9c7d8]">{user.email}</div>
                              </div>
                            </div>
                          </td>
                          <td className="py-3">
                            <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(user.status)} bg-opacity-20`}>
                          ...
                          <td className="py-3 text-sm text-[#a9c7d8]">{formatDate(user.lastLogin)}</td>
                          <td className="py-3">
                            <div className="text-sm">{user.tasks} tareas</div>
                            <div className="text-xs text-[#a9c7d8]">{user.projects} proyectos</div>
                          </td>
                          <td className="py-3">
                          ...
                          <td className="py-3">
                            <button className="text-[#a9c7d8] hover:text-white mr-2">
                              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {activeTab === 'users' && (
            <div className="bg-[#1a2a3a]/50 backdrop-blur-sm border border-[#2a3a4a]/30 rounded-2xl p-6">
              <div className="flex justify-between items-center mb-6">
                ...
                <button className="px-4 py-2 rounded-lg bg-gradient-to-r from-[#5ab9ea] to-[#84ceeb] text-[#0e1a26] font-medium hover:opacity-90 transition-all">
                  + Nuevo Usuario
                </button>
              </div>
              ...
              <div className="mb-6 flex items-center space-x-4">
                <div className="relative flex-1 max-w-md">
                  <input 
                    ...
                    className="w-full bg-[#0e1a26] border border-[#2a3a4a] rounded-xl px-4 py-2 pl-10 focus:outline-none focus:ring-2 focus:ring-[#5ab9ea] transition-all"
                  />
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 absolute left-3 top-2.5 text-[#5a7a8c]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                  </svg>
                </div>
                
                <select className="bg-[#0e1a26] border border-[#2a3a4a] rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#5ab9ea]">
                  ...
                  <thead>
                    <tr className="border-b border-[#2a3a4a]">
                      <th className="pb-3 text-left">
                        <input type="checkbox" className="rounded bg-[#0e1a26] border-[#2a3a4a]" />
                      </th>
                      <th className="pb-3 text-left">Usuario</th>
                      <th className="pb-3 text-left">Estado</th>
                      <th className="pb-3 text-left">Último acceso</th>
                      ...
                      <tr key={user.id} className="border-b border-[#2a3a4a]/30 hover:bg-[#1a2a3a]/50">
                        ...
                        <td className="py-3">
                          <div className="flex space-x-2">
                            ...
                            <button className="text-[#a9c7d8] hover:text-white" title="Ver detalles">
                              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
              ...
              <div className="flex justify-between items-center mt-6">
                <div className="text-sm text-[#a9c7d8]">
                  Mostrando 6 de {users.length} usuarios
                </div>
                <div className="flex space-x-2">
                  <button className="px-3 py-1 rounded-lg bg-[#0e1a26] border border-[#2a3a4a] text-sm disabled:opacity-50" disabled>
                    Anterior
                  </button>
                  <button className="px-3 py-1 rounded-lg bg-[#5ab9ea] text-[#0e1a26] text-sm">
                    1
                  </button>
                  <button className="px-3 py-1 rounded-lg bg-[#0e1a26] border border-[#2a3a4a] text-sm">
                    2
                  </button>
                  <button className="px-3 py-1 rounded-lg bg-[#0e1a26] border border-[#2a3a4a] text-sm">
                    Siguiente
                ...
                <div className="bg-[#1a2a3a]/50 backdrop-blur-sm border border-[#2a3a4a]/30 rounded-2xl p-6">
                  ...
                  <div className="h-64 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <div className="text-[#a9c7d8]">Tiempo promedio por usuario</div>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="text-center">
                      <div className="flex items-center justify-center space-x-4 mb-4">
                        <div className="flex items-center">
                          ...
                          <span className="text-sm">Completadas: 72%</span>
                        </div>
                        <div className="flex items-center">
                          <div className="w-4 h-4 bg-yellow-500 rounded mr-2"></div>
                          <span className="text-sm">En progreso: 18%</span>
                        </div>
                        <div className="flex items-center">
                          <div className="w-4 h-4 bg-red-500 rounded mr-2"></div>
                          <span className="text-sm">Pendientes: 10%</span>
                        </div>
                      </div>
                      <div className="w-40 h-40 rounded-full border-8 border-green-500 border-t-yellow-500 border-r-red-500 border-b-red-500 border-l-yellow-500 mx-auto"></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {activeTab === 'settings' && (
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between py-2">
                    <div>
                      ...
                      <div className="text-sm text-[#a9c7d8]">Desactiva el acceso público al sitio</div>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input type="checkbox" className="sr-only peer" />
                      <div className="w-11 h-6 bg-[#0e1a26] peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#5ab9ea]"></div>
                    </label>
                  </div>
                  ...
                  <div className="flex items-center justify-between py-2">
                    <div>
                      ...
                      <div className="text-sm text-[#a9c7d8]">Permitir que nuevos usuarios se registren</div>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  <div className="flex items-center justify-between py-2">
                    <div>
                      ...
                      <div className="text-sm text-[#a9c7d8]">Enviar notificaciones a los usuarios</div>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input type="checkbox" className="sr-only peer" checked />
                      <div className="w-11 h-6 bg-[#0e1a26] peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#5ab9ea]"></div>
              ...
              <div className="bg-[#1a2a3a]/50 backdrop-blur-sm border border-[#2a3a4a]/30 rounded-2xl p-6">
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium mb-2">Límite de almacenamiento por usuario (GB)</label>
                    <input type="number" className="w-full bg-[#0e1a26] border border-[#2a3a4a] rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#5ab9ea] transition-all" defaultValue="5" />
                  </div>
                  
                  <div>
                    <label className="block text-sm font-medium mb-2">Máximo de proyectos por usuario</label>
                    <input type="number" className="w-full bg-[#0e1a26] border border-[#2a3a4a] rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#5ab9ea] transition-all" defaultValue="10" />
                  </div>
                  
                  <div>
                    <label className="block text-sm font-medium mb-2">Máximo de tareas por proyecto</label>
                    <input type="number" className="w-full bg-[#0e1a26] border border-[#2a3a4a] rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#5ab9ea] transition-all" defaultValue="200" />
                  </div>
                </div>
                
                <button className="mt-6 px-4 py-2 rounded-lg bg-gradient-to-r from-[#5ab9ea] to-[#84ceeb] text-[#0e1a26] font-medium hover:opacity-90 transition-all">
                  Guardar Configuración
                </button>
              </div>
              
              <div className="bg-[#1a2a3a]/50 backdrop-blur-sm border border-[#2a3a4a]/30 rounded-2xl p-6">
                <h3 className="font-semibold mb-4">Zona Peligrosa</h3>
                <p className="text-[#a9c7d8] mb-4">Estas acciones son irreversibles. Procede con precaución.</p>
